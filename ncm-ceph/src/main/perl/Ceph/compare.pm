#${PMpre} NCM::Component::Ceph::compare${PMpost}
...
sub compare_config {
    ...
    my $cfgchanges = {};
    my $ceph_config;
    $ceph_config = dclone($ceph_config_orig) if defined($ceph_config_orig);
...
sub compare_conf {
    ...
    my $ceph_conf;
    $ceph_conf = dclone($ceph_conf_orig) if defined($ceph_conf_orig);
    my $structures = {
        configs  => {},
        deployd  => {},
        destroy  => {},
