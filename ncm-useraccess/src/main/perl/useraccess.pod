...
=item * /software/components/useraccess/acl_services

List of services that will hav ACLs associated to them.
...
neccessaryly) controlled by PAM.

B<IMPORTANT NOTE> this will add athe user to the given ACL, but will
