...
# Should compile fine.
object template  profile_testpm2fieldseach;

include pro_declaration_component_useraccess;
include pro_declaration_functions_useraccess;


"/software/components/useraccess/users/munoz" =
    nlist ("ssh_keys_urls",	list ("http://www.cern.ch/foo", "http://www.uam.es/bar"),
