################################################################################
# This is 'openldap.pod', a ncm-openldap's file
################################################################################
#
...
=head2 /software/components/openldap/entries

A list containing cron structures (described above).  

=head1 ENTRY RESOURCES

Each cron entry in the /software/components/openldap/entries list may 
