...
=item * C<< /software/components/gmond/file >> : string

The location of the configuration file. The correct value differs between 
Ganglia 3.0 (C<< /etc/gmond.conf >>) and Ganglia 3.1 (C<< /etc/ganglia/gmond.conf >>).
There is no default value.

=item * C<< /software/components/gmond/cluster >>

Cluster configuration with attributes name, owner, latlong and url.

=item * C<< /software/components/gmond/host >>

Host configuration with attribute location.

=item * C<< /software/components/gmond/globals >>
...
=item * C<< /software/components/gmond/udp_send_channel >>
...
=item * C<< /software/components/gmond/udp_recv_channel >>
...
=item * C<< /software/components/gmond/tcp_accept_channel >>
...
=item * C<< /software/components/gmond/collection_group >>
...
=item * C<< /software/components/gmond/module >>

List of modules.
Per module the attributes name, language, path, params and param can be specified.

=item * C<< /software/components/gmond/include >>
