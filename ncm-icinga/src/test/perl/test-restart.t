...
my %methods = (make_dirs => 0, print_general => 0, print_cgi => 0,
	       print_macros => 0, print_hosts => 0,
	       print_hosts_generic => 0, print_hostgroups => 0,
	       print_commands => 0, print_services => 0,
	       print_servicedependencies => 0, print_contacts => 0,
	       print_serviceextinfo => 0, print_hostdependencies => 0,
	       print_other => 0,
