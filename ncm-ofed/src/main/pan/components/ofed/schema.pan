...
type component_@COMP_openib_options = {
    onboot : boolean = true
...
type component_@COMP_openib_modules = {
    ucm ? boolean ? false
...
type component_@COMP_openib_hardware = {
    ## Mellanox
    ## Inifinihost III
    mthca ? boolean = false
    ## Connectx et al
...
type component_ofed_openib = {
    ...
    options : component_@COMP_openib_options
    modules : component_@COMP_openib_modules

    ## at least one needs to be on
    hardware : component_@COMP_openib_hardware
};
