...
use constant OPENIBOPTIONS_VALUE => qw(
    ipoib_mtu
    node_desc
    node_desc_update_timeout
...
sub Configure {
    ...
    ## main options
    $self->getcfg($config, $cfgfh, "options", OPENIBOPTIONS, OPENIBOPTIONS_VALUE);
...
sub getcfg {
    ...
    foreach my $option (@options) {
        ...
        if (grep {$_ eq $option} OPENIBOPTIONS_VALUE) {
            $ans=$tr->{$option};
        } else {
