declaration template quattor/aii/opennebula/qemu-schema;

include 'pan/types';

@documentation{
CPU models supported by the -cpu option of qemu.
To get a list of cpu models supported by a specific version of qemu, run
qemu -cpu help
See also https://qemu-project.gitlab.io/qemu/system/qemu-cpu-models.html
}
type qemu_cpu_model = choice(
    "486", # (alias configured by machine type) (deprecated)
    "486-v1", # (deprecated)
    ...
    "Conroe", # (alias configured by machine type) (deprecated)
    "Conroe-v1", # Intel Celeron_4x0 (Conroe/Merom Class Core 2) (deprecated)
    ...
    "Opteron_G1", # (alias configured by machine type) (deprecated)
    "Opteron_G1-v1", # AMD Opteron 240 (Gen 1 Class Opteron) (deprecated)
    "Opteron_G2", # (alias configured by machine type) (deprecated)
    "Opteron_G2-v1", # AMD Opteron 22xx (Gen 2 Class Opteron) (deprecated)
    "Opteron_G3", # (alias configured by machine type) (deprecated)
    "Opteron_G3-v1", # AMD Opteron 23xx (Gen 3 Class Opteron) (deprecated)
    ...
    "Penryn", # (alias configured by machine type) (deprecated)
    "Penryn-v1", # Intel Core 2 Duo P9xxx (Penryn Class Core 2) (deprecated)
    ...
    "athlon", # (alias configured by machine type) (deprecated)
    "athlon-v1", # QEMU Virtual CPU version 2.5+ (deprecated)
    "core2duo", # (alias configured by machine type) (deprecated)
    "core2duo-v1", # Intel(R) Core(TM)2 Duo CPU     T7700  @ 2.40GHz (deprecated)
    "coreduo", # (alias configured by machine type) (deprecated)
    "coreduo-v1", # Genuine Intel(R) CPU           T2600  @ 2.16GHz (deprecated)
    ...
    "n270", # (alias configured by machine type) (deprecated)
    "n270-v1", # Intel(R) Atom(TM) CPU N270   @ 1.60GHz (deprecated)
    "pentium", # (alias configured by machine type) (deprecated)
    "pentium-v1", # (deprecated)
    "pentium2", # (alias configured by machine type) (deprecated)
    "pentium2-v1", # (deprecated)
    "pentium3", # (alias configured by machine type) (deprecated)
    "pentium3-v1", # (deprecated)
    "phenom", # (alias configured by machine type) (deprecated)
    "phenom-v1", # AMD Phenom(tm) 9550 Quad-Core Processor (deprecated)
    "qemu32", # (alias configured by machine type) (deprecated)
    "qemu32-v1", # QEMU Virtual CPU version 2.5+ (deprecated)
    "qemu64", # (alias configured by machine type) (deprecated)
    "qemu64-v1", # QEMU Virtual CPU version 2.5+ (deprecated)
    ...
    "host-passthrough" # same as host
);

@documentation{
CPU features supported by the -cpu option of qemu.
To get a list of cpu features supported by a specific version of qemu, run
qemu -cpu help
}
type qemu_cpu_feature = choice(
    "3dnow",
    "3dnowext",
    "3dnowprefetch",
    "abm",
