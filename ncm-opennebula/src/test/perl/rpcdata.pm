...
$cmds{rpc_create_newuser}{params} = ["newuser", "myfancypass", "core"];
$cmds{rpc_create_newuser}{method} = "one.user.allocate";
$cmds{rpc_create_newuser}{out} = 5;
...
$cmds{rpc_create_newvnet}{out} = 78;
...
$cmds{rpc_list_datastore}{params} = [101];
...
$cmds{rpc_create_newhost}{params} = ["hyp102", "kvm", "kvm", "dummy", -1];
$cmds{rpc_create_newhost}{method} = "one.host.allocate";
$cmds{rpc_create_newhost}{out} = 173;
...
$cmds{rpc_delete_host}{params} = [167];
$cmds{rpc_delete_host}{method} = "one.host.delete";
$cmds{rpc_delete_host}{out} = 167;
