...
=item * /software/components/nagios/general

Global settings for Nagios. These settings will be written in
/etc/nagios/nagios.cfg .

=item * /software/components/nagios/cgi
...
=item * /software/components/nagios/hosts
...
=item * /software/components/nagios/services
...
=item * /software/components/nagios/external_dirs
...
=item * /etc/nagios/cgi.cfg

=item * /etc/nagios/contacts.cfg

=item * /etc/nagios/contactgroups.cfg

=item * /etc/nagios/hosts.cfg

=item * /etc/nagios/hostgroups.cfg

=item * /etc/nagios/hostdependencies.cfg

=item * /etc/nagios/services.cfg

=item * /etc/nagios/servicegroups.cfg

=item * /etc/nagios/servicedependencies.cfg

=item * /etc/nagios/serviceextinfo.cfg

=item * /etc/nagios/timeperiods.cfg

=item * /etc/nagios/commands.cfg

=item * /etc/nagios/resources.cfg
