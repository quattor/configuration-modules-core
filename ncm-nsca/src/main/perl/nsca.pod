...
=item * /software/components/nsca/daemon/aggregate_writes : boolean
...
=item * /software/components/nsca/daemon/append_to_file : boolean

This option determines whether or not the nsca daemon will
will open the external command file for writing or appending.
Defaults to false.

=item * /software/components/nsca/daemon/max_packet_age : long

This option is used by the nsca daemon to determine when client
data is too old to be valid.
Defaults to 30.

=item * /software/components/nsca/daemon/password : string

This is the password/passphrase that should be used to decrypt the
incoming packets.

=item * /software/components/nsca/daemon/decryption_method : boolean
...
=item * /software/components/nsca/send/password : string

This is the password/passphrase that should be used to encrypt the
outgoing packets.

=item * /software/components/nsca/send/encryption_method : long
