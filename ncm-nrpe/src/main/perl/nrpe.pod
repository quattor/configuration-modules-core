...
=item * C<< /software/components/nrpe/log_facility : string >>

The syslog facility that should be used for logging purposes.

=item * C<< /software/components/nrpe/pid_file : string >>

File in which the NRPE daemon should write it's process ID number.

=item * C<< /software/components/nrpe/server_port : type_port >>

The port the daemon will listen to.

=item * C<< /software/components/nrpe/server_address ? string >>

Address that nrpe should bind to if you do not want nrpe to bind on all interfaces.

Optional field.

=item * C<< /software/components/nrpe/nrpe_user : string >>

User the daemon will run as. For instance, 'nagios'.

=item * C<< /software/components/nrpe/nrpe_group : string >>

Group the daemon will run as. For instance, 'nagios'.

=item * C<< /software/components/nrpe/allowed_hosts : type_hostname[] >>

List of hosts allowed to order the NRPE daemon to run commands.

=item * C<< /software/components/nrpe/dont_blame_nrpe : boolean >>
...
=item * C<< /software/components/nrpe/command_prefix ? string >>
...
=item * C<< /software/components/nrpe/debug : boolean >>

Whether or not debugging messages are logged to the syslog facility.

=item * C<< /software/components/nrpe/command_timeout : long >>

Timeout for commands, in seconds.

=item * C<< /software/components/nrpe/connection_timeout : long >>

Timeout for connections, in seconds.

=item * C<< /software/components/nrpe/allow_weak_random_seed : boolean >>

Whether or not allow weak random number generation.

=item * C<< /software/components/nrpe/command : string {} >>
...
=item * C<< /software/components/nrpe/include : string [] >>

List of external file names that should be included. 

=item * C<< /software/components/nrpe/include_dir : string [] >>
