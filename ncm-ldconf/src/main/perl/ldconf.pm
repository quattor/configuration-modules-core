...
#######################################################################
#
# This component behaves differently on SL3 and SL4 :
#    - On SL3 or equivalent, /etc/ld.so.conf is updated directly, in-place.
#    - On SL4 or systems supporting 'include' directive, a specific configuration
#      file is created for entries managed by ncm-ldconf.
#
#######################################################################
