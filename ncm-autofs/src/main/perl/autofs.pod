...
=head2 C<< /software/components/autofs/preserveMaster : boolean >>
...
=head2 C<< /software/components/autofs/maps : nlist >>
...
=head2 C<< /software/components/autofs/maps/XXX/enabled : boolean >>

If false, ignore entries for this map (no change made).

Default : true.

=head2 C<< /software/components/autofs/maps/XXX/entries : nlist >>
...
=head2 C<< /software/components/autofs/maps/XXX/mapname : string >>

Map name. If not defined, a default name is build (/etc/auto suffixed
by map entry name.

=head2 C<< /software/components/autofs/maps/XXX/mountpoint : string >>

Mount point associated with this map.

Default : none.

=head2 C<< /software/components/autofs/maps/XXX/mpaliases : string >>

Mount point aliases. Deprecated feature.

=head2 C<< /software/components/autofs/maps/XXX/options : string >>

Mount options to be used with this map.

Default : none.

=head2 C<< /software/components/autofs/maps/XXX/preserve : boolean >>
...
=head2 C<< /software/components/autofs/maps/XXX/type : string >>
...
=head2 C<< /software/components/autofs/maps/XXX/entries/YYY/location : string >>

NFS server name/path associated with this entry.

Required, no default.

=head2 C<< /software/components/autofs/maps/XXX/entries/YYY/options : string >>
...
=head2 Scenario 2 : More details configuration
