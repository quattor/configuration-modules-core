...
=head2 /software/components/filecopy/forceRestart: boolean (required)
...
=head2 /software/components/filecopy/services: nlist (optional)
...
=head3 no_utf8: boolean (optional)
...
=head3 forceRestart: boolean (required)
