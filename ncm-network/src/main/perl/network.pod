...
These values are used to generate the /etc/sysconfig/network file. ("realhostname", "guess_default_gateway", "default_gateway", "nisdomain" and "nozeroconf" are optional).
