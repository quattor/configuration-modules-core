...
NCM::Component::spma::yum-ng - NCM SPMA configuration component for Yum
...
FIXME: Is this implemented here?
...
FIXME: What happens to /etc/yum.d/* when this is set to yes?
...
Will not execute the package changes if this file is not present and
/software/components/spma/run is set to "no".

=head1 NOTES

This component honours the B<--noaction> mode.
