...
=item * C<< /software/components/spma/unescape >> : boolean
...
=item * C<< /software/components/spma/tmpdir >> : string
...
=item * C<< /software/components/spma/userprio >> : string ("yes|no")

Obsoleted and ignored.

=item * C<< /software/components/spma/protectkernel >> : string ("yes|no")
...
=item * C<< /software/components/spma/usespmlist >> : string ("yes|no")

Obsolete. Currently ignored.

=item * C<< /software/components/spma/rpmexclusive >> : string ("yes|no")

Obsolete. Currently ignored.

=item * C<< /software/components/spma/debug >> : string ("0|1|2|3|4|5")

Obsolete. Currently ignored.

=item * C<< /software/components/spma/verbose >> : string ("0|1")

Obsolete. Currently ignored.

=item * C<< /software/components/spma/cachedir >> : string

Obsolete. Currently ignored.

=item * C<< /software/components/spma/localcache >> : string ("yes|no")
...
=item * C<< /software/components/spma/headnode >> : boolean
...
This component honors the C<< --noaction >> mode.
